...
export const translations: Record<Locale, SiteContent> = {
  it: {
    ...
    merchandise: {
      ...
      ctaSecondaryHref: 'https://wa.me/41765933666',
    },
	    testimonials: {
    ...
    booking: {
      ...
      whatsappLabel: 'Prenota via WhatsApp',
	      whatsappHref: 'https://wa.me/41765933666',
	      emailLabel: 'Scrivici una mail',
	      emailHref: 'mailto:info@arenabarbershop.ch',
      hours: [
        'Lunedì · Chiuso',
      ...
      ambienceImage: {
	    ...
	    footer: {
	      ...
	      phoneLabel: '+41 76 593 36 66',
	      phoneHref: 'tel:+41765933666',
	      emailLabel: 'info@arenabarbershop.ch',
	      emailHref: 'mailto:info@arenabarbershop.ch',
	      socials: [
